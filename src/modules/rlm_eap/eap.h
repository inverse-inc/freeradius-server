...
typedef struct rlm_eap_module {
	...
	int (*serialize)(REQUEST *request, void *instance, REQUEST *fake, eap_handler_t *handler);	//!< serialize eap session.
	int (*deserialize)(REQUEST *request, void *instance, REQUEST *fake, eap_handler_t *handler);	//!< deserialize eap session.
